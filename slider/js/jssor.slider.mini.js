(function (k, f, c, j, d, l, g) {/*! Jssor */
    ...
    var i = k.$JssorSlider$ = function (p, hc) {
        ...
        var rb = a.$BulletNavigatorOptions, W = a.$ArrowNavigatorOptions, ab = a.$ThumbnailNavigatorOptions, Q = !a.$UISearchMode, y, v = b.C(p, "slides", Q), cb = b.C(p, "loading", Q) || b.jb(f), Jb = b.C(p, "navigator", Q), ec = b.C(p, "arrowleft", Q), cc = b.C(p, "arrowright", Q), Hb = b.C(p, "thumbnavigator", Q), pc = b.k(v), oc = b.m(v), V, T = [], yc = b.Ab(v);
        b.a(yc, function (a) {
        ...
        if (r) {
            ...
            var xb = v, C = [], A, N, Fb = b.kf(), kb = Fb.Wf, G, qb, Kb, tb;
