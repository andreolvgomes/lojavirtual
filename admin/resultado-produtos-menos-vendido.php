...
$produtos_que_menos_vende = $dao_produtos->buscaResultado_ProdutosQueMenosVende();
?>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <legend>
                <h1>10 Menos Vendidos</h1>
            </legend>
        </div>
    </div>

    <div class="row">
        <?php if (count($produtos_que_menos_vende) > 0) { ?>
            <table class="table table-bordered table-condesed table-striped">
                ...
                <tbody>
                    <?php foreach ($produtos_que_menos_vende as $produto): ?>
                        <tr>
